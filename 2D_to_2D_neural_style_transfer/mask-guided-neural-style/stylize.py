...
def  main(args):
    ...
    output_path = os.path.join("StyleWeight " + str(args.style_weight) + "ContentWeight" + str(args.content_weight) + "Iters " + str(args.iteration)
        ,os.path.join(args.output_dir, os.path.split(os.path.splitext(args.content_img)[0])[1]+'2'+os.path.split(os.path.splitext(args.style_img)[0])[1]+ '.png')) 

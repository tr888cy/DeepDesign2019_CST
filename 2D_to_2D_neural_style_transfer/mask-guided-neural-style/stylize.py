...
def  main(args):
    ...
    moreInfo = "C" + str(args.content_weight) + "S" + str(args.style_weight) +  "I" + str(args.iteration)
    output_path = os.path.join(args.output_dir, os.path.split(os.path.splitext(args.content_img)[0])[1]+'to'+os.path.split(os.path.splitext(args.style_img)[0])[1]+ moreInfo + '.jpg')
